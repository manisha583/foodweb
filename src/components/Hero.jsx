...
function Hero() {
  return (
    <section id="home" className="py-1 px-1">
      <div
      ...
      >
        <div className="ml-4 sm:ml-8 md:ml-12 max-w-[180px] sm:max-w-sm md:max-w-lg text-white md:mt-25 ">
          ...
          <button className="mt-5 sm:mt-5 rounded-full bg-white px-3 py-1.5 sm:px-5 sm:py-2 text-xs sm:text-sm md:text-[15px] text-black cursor-pointer hover:text-orange-700 ">
            View Menu
          </button>
        </div>
      </div>
