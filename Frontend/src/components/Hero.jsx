    ...
    <section className="py-1 px-1">
      ...
      >
        <div className="ml-4 animate-fade-in sm:ml-8 md:ml-12 max-w-[180px] sm:max-w-sm md:max-w-lg text-white md:mt-25 ">
          ...
          <button className="hidden sm:block sm:mt-5 rounded-full bg-orange-600 px-3 py-1.5 sm:px-5 sm:py-2 text-xs sm:text-sm md:text-[15px] text-white cursor-pointer hover:bg-orange-500 transition duration-300 ease-in-out">
            View Menu
          </button>
        </div>
      </div>
